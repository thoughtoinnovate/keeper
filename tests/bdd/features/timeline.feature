Feature: Due date timeline
  ...
  Scenario: Show due timeline with overdue tasks
    ...
    And I add a note "Old task" in bucket "@work" with priority "!p2" and due date "^2020-01-01"
    And I add a note "Soon task" in bucket "@work" with priority "!p1" and due date "^2026-02-01"
